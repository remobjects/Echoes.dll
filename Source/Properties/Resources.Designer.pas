...
class method Resources.get_strAmbigiousOverload: System.String;
begin
    exit(ResourceManager.GetString('strAmbigiousOverload', resourceCulture));
end;

class method Resources.get_strAmbigiousOverloadStr: System.String;
begin
    exit(ResourceManager.GetString('strAmbigiousOverloadStr', resourceCulture));
end;

class method Resources.get_strCannotInvokeNonDelegate: System.String;
begin
    exit(ResourceManager.GetString('strCannotInvokeNonDelegate', resourceCulture));
end;

class method Resources.get_strInvalidOperands: System.String;
begin
    exit(ResourceManager.GetString('strInvalidOperands', resourceCulture));
end;

class method Resources.get_strInvalidOperator: System.String;
begin
    exit(ResourceManager.GetString('strInvalidOperator', resourceCulture));
end;

class method Resources.get_strNoConstructors: System.String;
begin
    exit(ResourceManager.GetString('strNoConstructors', resourceCulture));
end;

class method Resources.get_strNoDefaultProperty: System.String;
begin
    exit(ResourceManager.GetString('strNoDefaultProperty', resourceCulture));
end;

class method Resources.get_strNoMethodsByThatName: System.String;
begin
    exit(ResourceManager.GetString('strNoMethodsByThatName', resourceCulture));
end;

class method Resources.get_strNoOverloadWithTheseParameters: System.String;
begin
    exit(ResourceManager.GetString('strNoOverloadWithTheseParameters', resourceCulture));
end;

class method Resources.get_strNoPropertiesByThatName: System.String;
begin
